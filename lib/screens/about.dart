        ...
        children: [
          Column(
            children: [
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        children: [
                          SizedBox(width: 40),
                          Icon(Icons.heart_broken_rounded, size: 60),
                          SizedBox(width: 40),
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        children: [
                          SizedBox(width: 40),
                          Icon(Icons.handshake_rounded, size: 60),
                          SizedBox(width: 40),
              ...
              Text("EXTC TY Student K J Somaiya College Of Engineering",
                    ...
                    child: Column(
                      children: [
                        ClipRRect(
                          ...
                          child: Image.asset('images/hungppl.png', width: 200),
                        ),
                        SizedBox(height: 10),
